...
export default async function BusSearchPage({ searchParams }: SearchPageProps) {
  const params = await searchParams;

  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Search bus tickets</h1>
        <div className="bg-brand-700 rounded-2xl p-4">
          <TransportSearchForm
            activeType={TRANSPORT_TYPES.BUS}
            compact
